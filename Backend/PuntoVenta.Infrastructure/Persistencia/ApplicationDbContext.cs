...
namespace PuntoVenta.Infrastructure.Persistencia
{
    public class ApplicationDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Configuración de AuditoriaAccion
            modelBuilder.Entity<AuditoriaAccion>(entity =>
            {
                entity.ToTable("auditorias_acciones");
                entity.HasKey(e => e.Id);
                entity.Property(e => e.Id).ValueGeneratedOnAdd();
                entity.Property(e => e.UsuarioId).IsRequired().HasMaxLength(50);
                ...
                entity.Property(e => e.RegistroAfectadoDescripcion).HasMaxLength(500);
