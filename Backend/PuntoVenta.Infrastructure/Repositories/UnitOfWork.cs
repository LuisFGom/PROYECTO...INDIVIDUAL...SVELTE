...
namespace PuntoVenta.Infrastructure.Repositories
{
    ...
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private IAuditoriaAccionRepository? _auditoriaAccionRepository;
        ...
        public IAuditoriaAccionRepository AuditoriasAcciones
        {
            get
            {
                return _auditoriaAccionRepository ??= new AuditoriaAccionRepository(_context);
            }
        }
