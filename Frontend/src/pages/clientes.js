...
export class Clientes {
  ...
  render() {
    ...
    return `
<div class="clientes-page" style="padding: 20px;">
  <div class="page-header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
    <h1 class="page-title" style="font-size: 28px; color: #1E293B; margin: 0;"><i class="fas fa-users"></i> Clientes</h1>
    ${isAdmin ? `
      <button class="btn-add-cliente" title="Crear nuevo cliente" style="padding: 10px 20px; background: #3B82F6; color: white; border: none; border-radius: 8px; cursor: pointer; font-weight: 600;">
    ...
    const formHTML = `
      <form id="clienteForm" novalidate style="width: 100%;">
        <div style="margin-bottom: 15px;">
          ...
          <input type="text" id="clienteNombre" placeholder="Nombre" required style="width: 100%; padding: 10px; border: 1px solid #E2E8F0; border-radius: 6px; box-sizing: border-box;"/>
        </div>
        <div style="margin-bottom: 15px;">
          <label style="display: block; margin-bottom: 5px; font-weight: 600; color: #0F172A;">Apellido: <span style="color:red">*</span></label>
          <input type="text" id="clienteApellido" placeholder="Apellido" required style="width: 100%; padding: 10px; border: 1px solid #E2E8F0; border-radius: 6px; box-sizing: border-box;"/>
        </div>
        <div style="margin-bottom: 15px;">
  ...
  async saveCliente(e) {
    ...
    if (!this.editingId && documento && !/^\d{10}$/.test(documento)) {
      Swal.fire({ icon: 'warning', title: 'Cédula inválida', text: 'La cédula debe contener exactamente 10 dígitos numéricos.', confirmButtonColor: '#F59E0B' })
      return
    }
  ...
  async editCliente(id) {
    ...
    if (!cliente) {
      Swal.fire({ icon: 'error', title: 'Error', text: 'Cliente no encontrado.', confirmButtonColor: '#EF4444' })
      return
    }
    ...
    const formHTML = `
      <form id="clienteForm" novalidate style="width: 100%;">
        <div style="margin-bottom: 15px;">
          <label style="display: block; margin-bottom: 5px; font-weight: 600; color: #0F172A;">Nombre: <span style="color:red">*</span></label>
          <input type="text" id="clienteNombre" placeholder="Nombre" value="${cliente.nombre || ''}" required style="width: 100%; padding: 10px; border: 1px solid #E2E8F0; border-radius: 6px; box-sizing: border-box;"/>
        </div>
        <div style="margin-bottom: 15px;">
          <label style="display: block; margin-bottom: 5px; font-weight: 600; color: #0F172A;">Apellido: <span style="color:red">*</span></label>
          <input type="text" id="clienteApellido" placeholder="Apellido" value="${cliente.apellido || ''}" required style="width: 100%; padding: 10px; border: 1px solid #E2E8F0; border-radius: 6px; box-sizing: border-box;"/>
        </div>
        <div style="margin-bottom: 15px;">
